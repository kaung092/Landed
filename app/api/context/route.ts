...
// GET /api/context -> the read-context CoWork consults before self-initiating a job.
...
//     CoWork normalizes collected levels.fyi ladders to the same scale the app draws against
